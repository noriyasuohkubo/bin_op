...
#IND_RANGES [['0-0.07'], ['0-0.05'], [], ['0-0.12'], ['0-0.11'], ['0.01-0.07'], ['0-0.3'], ['0.03-0.2'], []]
...
INDS = [
    ...
    ["60-satr-5", ['0-0.12']],
    ["60-satr-15", ['0-0.11']],
    ["60-satr-45", ['0.01-0.07']],

    ["300-satr-5", ['0-0.3']],
    ["300-satr-15", ['0.03-0.2']],
]
    ...
    for i in range(len(INPUT_LEN)):
        ...
        if init_flg:
            ...
            while True:
                ...
                divide_org = 1 if closes[shift_idx + shift] == closes[shift_idx] else closes[shift_idx + shift] / \
                                                                                      closes[shift_idx]
