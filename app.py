...
#for 0.54
border_list_both =  {-1: [0.50, 0.50], 1: [0.54, 0.52], 2: [0.6, 0.56],
         3: [0.58, 0.57], 4: [0.54, 0.54], 5: [0.52, 0.54] ,
         6: [0.55, 0.61], 7: [0.58, 0.57], 8: [0.51, 0.55]}
...
def get_atr(close_data, high_data, low_data, period):
    ...
    target = get_divide_np(close_data, (atr_data + close_np))
