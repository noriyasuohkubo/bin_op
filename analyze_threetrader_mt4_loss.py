...
"""
threetrader(MT4)の発注履歴から理論上と実際取引のレートのスリップを日毎に取得する
"""
...
#DB情報
db_name = symbol + "_MT4_THREETRADER_ORDER"
db_name_history = symbol + "_MT4_THREETRADER_HISTORY"
...
#レコード対象期間
start_dt = datetime(2024, 9, 10, 23 )
...
while True:
    ...
    for i, v in enumerate(result_data_history):
        ...
        order_ticket = int(tmps.get("order_ticket"))
