...
endDt = datetime.datetime(2024, 12, 1)
...
#不要なカラム
drop_cols = []
for i in [ 611, 627, 643, 659, 675, 691, 707, 723, 739, 755, 771, 787, 803, 819, 835, 851, 867, 883, 899, 915, 931,
           963, 995, 1027, 1059, 1091, 1123, 1155, 1187, 1219, 1251, 1283, 1315, 1347, 1379, 1411, 1440]:
    drop_cols.append("1-sma-" + str(i))
...
#残すカラム
#not_drop_cols = '1457-77-DW@1457-77-SAME@1457-77-UP@1500-196-DW@1500-196-SAME@1500-196-UP@1504-196-DW@1504-196-SAME@1504-196-UP@1510-81-DW@1510-81-SAME@1510-81-UP@1560-271-DW@1560-271-SAME@1560-271-UP@1562-157-DW@1562-157-SAME@1562-157-UP@1583-394-DW@1583-394-SAME@1583-394-UP@1595-506-DW@1595-506-SAME@1595-506-UP@1626-229-DW@1626-229-SAME@1626-229-UP@1633-79-DW@1633-79-SAME@1633-79-UP@1734-448-DW@1734-448-SAME@1734-448-UP@1750-883-DW@1750-883-SAME@1750-883-UP@1808-144-DW@1808-144-SAME@1808-144-UP@1835-67-DW@1835-67-SAME@1835-67-UP@1852-200-DW@1852-200-SAME@1852-200-UP@1865-167-DW@1865-167-SAME@1865-167-UP@o@score'.split('@')
not_drop_cols = []
...
# 終わったらメールで知らせる
mail.send_message("ub3 make_drop_col_pandas finished!!!")