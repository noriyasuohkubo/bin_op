...
#DB情報
db_name_order = "USDJPY_4_MONEYPARTNERS_ORDER"
db_name_history = "USDJPY_4_MONEYPARTNERS_HISTORY"

db_no = 8
host = "192.168.1.17" #win7
...
"""
{
  "order_score": 1737938231,
  "deal_score": 1737938319,
  "start_rate": 155.58,
  "end_rate": 155.553,
  "profit": 0.027,
  "sign": 0,
...
for i, v in enumerate(result_data):
    ...
    start_rate_tm = float(tmps.get("start_rate_moneypartners"))
