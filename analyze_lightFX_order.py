...
"""
Lion FXの発注履歴から勝率と平均獲得pipsを算出する
"""

#DB情報
db_name = "USDJPY_4_LightFX_ORDER"
db_name_history = "USDJPY_4_LIGHTFX_HISTORY"
...
for i, v in enumerate(result_data):
    ...
    start_rate_lion = float(tmps.get("start_rate_lightFX"))
