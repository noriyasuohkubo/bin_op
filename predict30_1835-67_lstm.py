...
class Conf():
    def __init__(self):
        ...
        self.MODEL_DATA_LENGTH = [[3, 200],]
        self.MODEL_INPUT_DATAS = ["d1",]
        self.MODEL_INPUT_SEPARATE_FLG = True
        self.MODEL_METHOD = "LSTM1"
        ...
        self.SERVER_NAME = "win5_" + self.MODEL_CODE

        self.START_TIME = datetime.datetime(year=2025, month=3, day=9, hour=23, minute=0, second=0, microsecond=0)
        ...
        self.MAX_CLOSE_LEN = 603 #渡されるcloseの長さ
    ...
    try:
        ...
        while (True):
            ...
            child = {
                ...
                'now_rate': now_rate,
                'predict_take': conf.RATE_FORMAT.format(predict_take),
