...
cat_bin_both_models = {
    0: [
        'EURUSD_CATEGORY_BIN_UP_LSTM7_TYPE-LSTM1_BET2_TERM30_INPUT2-10-30_INPUT_LEN300-300-240_L-UNIT25-25-20_D-UNIT48-24-12_LSTMDO0.05_DROP0.05_BNL2_BDIV0.1_201601_202210_L-RATE0.001_LOSS-C-ENTROPY_ADAM_d1-M1_OT-d_OD-c_IDL1_BS10240_SEED0_SHUFFLE_ub1-40',
        'EURUSD_CATEGORY_BIN_DW_LSTM7_TYPE-LSTM1_BET2_TERM30_INPUT2-10-30_INPUT_LEN300-300-240_L-UNIT25-25-20_D-UNIT48-24-12_LSTMDO0.05_DROP0.05_BNL2_BDIV0.1_201601_202210_L-RATE0.001_LOSS-C-ENTROPY_ADAM_d1-M1_OT-d_OD-c_IDL1_BS10240_SEED0_SHUFFLE_ub1-29'
    ]
}
#for 0.56
border_list_both = {-1: [0.6, 0.6], 0: [0.54, 0.56],}
...
#satrによって対象を絞り込む場合、範囲を-区切りでリストにする
ATR = ['0-0.0006', ] #["0.5-1", "7-100"]
    ...
    if now_sec % (TRADE_DIVIDE * BET_TERM) == (tmp_divide_min * BET_TERM):
        ...
        if spr in models:
            ...
            if len(ATR) != 0:
                ...
                tmp_atrs = get_satr(close_data, high_data, low_data, ATR_PERIOD)
...
if __name__ == "__main__":
    #app.run()  # for highlow
    app.run(port=5001) #option
    #app.run(port=6001) #zentrader
