...
cat_bin_both_models = {
    0: [
        ...
        "GBPJPY_CATEGORY_BIN_DW_LSTM7_BET2_TERM30_INPUT2-10-30-90-300_INPUT_LEN300-300-240-80-24_L-UNIT30-30-24-8-4_D-UNIT16-8-4_DROP0.0_L-K0_L-R0_DIVIDEMAX0_SPREAD1_UB1_202101_90_L-RATE0.001_LOSS-C-ENTROPY_GU-GU-GU-7",
    ]
}
#for 0.585
border_list_both = {-1: [0.57, 0.55], 0: [0.59, 0.58],}
