...
cat_bin_both_models = {
    0: [
        "EURUSD_LT3_M7_LSTM1_B2_T30_I2-10-60-300_IL300-300-240-48_LU30-30-24-5_DU96-48-24-12_BNL2_BDIV0.01_201001_202210_L-RATE0.002_LT1_ADAM_d1-M1_OT-d_OD-c_IDL1_BS15360_SD0_SHU1_EL20-21-22_ub1_MN202-7",
        "EURUSD_LT4_M7_LSTM1_B2_T30_I2-10-60-300_IL300-300-240-48_LU30-30-24-5_DU96-48-24-12_BNL2_BDIV0.01_201001_202210_L-RATE0.002_LT1_ADAM_d1-M1_OT-d_OD-c_IDL1_BS15360_SD0_SHU1_EL20-21-22_ub1_MN203-17"
    ]
}
#for 0.572
...
#ind_range_bases: [['0-0.0007'], [], [], ['0-0.0013'], [], [], [], [], [], ['0-0.003'], ['0.0004-0.0019'], ['0.0006-0.0014'], ['0-0.0012']]
...
INDS = [
    ["10-satr-5", ['0-0.0007']],
    ["60-satr-5", ['0-0.0013']],
    ["1800-fsatr-5", ['0-0.003']],
    ["1800-fsatr-15", ['0.0004-0.0019']],
    ["1800-fsatr-45", ['0.0006-0.0014']],
    ["1800-fsatr-70", ['0-0.0012']],
]
"""
INDS = []
#indの計算に必要な１番長い長さを保持
...
def hello():
        ...
        if spr in models:
            ...
            if len(INDS) != 0:
                for j, tmp_a in enumerate(INDS):
                    ...
                    ind_range = tmp_a[1]
                    if ind_name == "satr" or ind_name == "fsatr":
    ...
    print(str(res) + "_" + str(atr_list[0]))

    #return "0_3.3e-05" #テスト用
    return str(res) + "_" + str(atr_list[0])
